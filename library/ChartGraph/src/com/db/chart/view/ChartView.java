	...
	private void digestData() {
		...
		for(ChartSet set: data){
			...
			for(int i = 0; i < set.size_Middle(); i++){
				set.getMiddleEntry(i).setCoordinates(horController.parsePos(Float.valueOf(set.getMiddleLabel(i)), set.getMiddleValue(i)),
						verController.parsePos(Float.valueOf(set.getMiddleLabel(i)), set.getMiddleValue(i)));
			}
		}
	}
