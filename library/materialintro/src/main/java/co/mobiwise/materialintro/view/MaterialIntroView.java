...
public class MaterialIntroView extends RelativeLayout {
    ...
    /**
     * InfoID Text in Info Dialog
     */
    private TextView textViewID;

    /**
     * Info ID Text will be shown
     * If this value true
     */
    private boolean isInfoIDEnabled;
    ...
    /**
     * arrow type
     * if this is 0, no arrow, 1, red, 2, blue arrow
     */
    ...
    private void init(Context context) {
        ...
        textViewID = (TextView) layoutInfo.findViewById(R.id.textview_id);
        textViewID.setTextColor(colorTextViewInfo);
        ...
        arrowView = (ImageView)LayoutInflater.from(getContext()).inflate(R.layout.arrow_view, null);
        arrowView.measure(MeasureSpec.UNSPECIFIED, MeasureSpec.UNSPECIFIED);
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (circleShape != null && circleShape.getPoint().y != 0 && !isLayoutCompleted) {
                    ...
                    if(isDotViewEnabled)
                        setDotViewLayout();
                    if(arrowType != ArrowType.AT_NORMAL)
                        setArrowViewLayout();
     ...
     * above the circle. Otherwise locate below.
     */
    private void setArrowViewLayout() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                AnimationFactory.performMiniAnimation(arrowView);
            }
        });
    }
    ...
    private void setColorTextViewInfo(int colorTextViewInfo) {
        ...
        textViewID.setTextColor(this.colorTextViewInfo);
    }
    ...
    private void setInfoIDText(String textViewID){
        this.textViewID.setText(textViewID);
    }

    private void enableInfoIDText(boolean isInfoIDEnabled) {
        this.isInfoIDEnabled = isInfoIDEnabled;
        if( this.isInfoIDEnabled )
    ...
    private void setArrowType(ArrowType type) { this.arrowType = type; }
    /**
     * Builder Class
     */
    public static class Builder {
        ...
        public Builder setUsageId(String materialIntroViewId) {
            ...
            materialIntroView.setInfoIDText(materialIntroViewId);
            return this;
        }
        ...
        public Builder enableInfoIDText(boolean isInfoIDEnabled) {
            materialIntroView.enableInfoIDText(isInfoIDEnabled);
            return this;
        }
        ...
        public Builder setArrowType(ArrowType type) {
            materialIntroView.setArrowType(type);
            return this;
        }
